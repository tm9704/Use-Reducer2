...
const Login = (props) => {
  ...
  const [passwordState, dispatchPasssword] = useReducer(passwordReducer, {
    value: "",
    isValid: null,
  });
  ...
  const passwordChangeHandler = (event) => {
    dispatchPasssword({ type: "USER_INPUT", val: event.target.value });
  ...
  const validatePasswordHandler = () => {
    dispatchPasssword({ type: "INPUT_BLUR" });
  };
